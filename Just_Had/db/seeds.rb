...
u1 = User.create!(email: "larry@larry.com", encrypted_password: "password", username: "larlar")
u2 = User.create!(email: "mike@mike.com", encrypted_password: "password", username:"MandM")
u3 = User.create!(email:"john@john.com", encrypted_password: "password", username: "johhnyboy")
u4 = User.create!(email:"ashley@ashley.com", encrypted_password: "password", username: "lilash")
u5 = User.create!(email:"jasmine@jasmine.com", encrypted_password: "password", username: "minniej")
u6 = User.create!(email:"roy@roy.com", encrypted_password: "password", username: "royalty")
u7 = User.create!(email:"sed@sed.com", encrypted_password: "password", username: "sedstan")
u8 = User.create!(email:"daisy@daisy.com", encrypted_password: "password", username: "floweryd")
...
u4.suggestion.create!(description: "Massive portions at The Diner!", food_type: "meal", category:"breakfast", location: "4 Horner Square London E1 6EW", longitude: "", latitude: "", food_image: "")
